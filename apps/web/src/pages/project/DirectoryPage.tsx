  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Roster for this site — employees from HRM and vendor companies. Feeds Communications (matrix) and meeting TO/CC lists. Maintain the company pool in HR / Directory."
        actions={
