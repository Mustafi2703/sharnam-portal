...
export const PORTAL_LOGINS: Record<string, PortalConfig> = {
  ...
  quality: {
    ...
    subtitle: "Quality Inspections and Safety as separate tools, plus QI forms and QI fill RFIs.",
    demoEmail: "site@sharnam.demo",
    allowedRoles: ["admin", "office", "employee", "site_employee", "vendor"],
    points: ["Quality Inspections", "Safety (separate)", "QI checklist forms", "QI fill RFIs"],
