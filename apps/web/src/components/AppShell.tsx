...
const officeAdminNav: { to: string; label: string; icon: ModuleIconKey }[] = [
  ...
  { to: "/hrms/recruitment", label: "Recruitment", icon: "modules" },
  { to: "/hrms/onboarding", label: "Onboarding", icon: "modules" },
  { to: "/hrms/payroll", label: "Payroll", icon: "reports" },
  { to: "/hrms/attendance", label: "Attendance", icon: "field" },
  { to: "/hrms/leave", label: "Leave", icon: "modules" },
  { to: "/hrms/masters", label: "Leave types / Holidays", icon: "reports" },
