...
export function buildVendorBoqTemplateXlsx(opts: {
  ...
  const instructions: (string | number)[][] = [
    ...
    [""],
    ["Fill RATE column only — QTY, description, and unit come from project budget monitoring."],
    ["Description, unit, and qty columns are read-only on the portal — amount auto-calculates from qty × rate."],
