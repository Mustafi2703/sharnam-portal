...
export const LIVE_TEAM: { email: string; fullName: string; role: RoleKey; org: string }[] = [
  ...
  { email: "akshay.lad@spdc.in", fullName: "Akshay Lad", role: "site_employee", org: "SPDC" },
  { email: "nitin.vankar@spdc.in", fullName: "Nitin Vankar", role: "site_employee", org: "SPDC" },
  { email: "hitesh.rajput@spdc.in", fullName: "Hitesh Rajput", role: "site_employee", org: "SPDC" },
  { email: "jaideep.parmar@spdc.in", fullName: "Jaideep Parmar", role: "site_employee", org: "SPDC" },
  { email: "ravi.solanki@spdc.in", fullName: "Ravi Solanki", role: "site_employee", org: "SPDC" },
  { email: "jaypal.rathod@spdc.in", fullName: "Jaypal Rathod", role: "site_employee", org: "SPDC" },
  { email: "planning.estimation@spdc.in", fullName: "Planning & Estimation", role: "site_employee", org: "SPDC Planning" },
  { email: "anushka.jha@spdc.in", fullName: "Anushka Jha (HR Head)", role: "hr", org: "SPDC HR" },
  { email: "info@spdc.in", fullName: "SPDC Info Desk", role: "site_employee", org: "SPDC" },
  { email: "pratik.solanki@spdc.in", fullName: "Pratik Solanki", role: "site_employee", org: "SPDC" },
];
