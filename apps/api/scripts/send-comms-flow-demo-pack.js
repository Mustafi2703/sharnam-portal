...
import { buildRfiClosedEmail, buildRfiRaisedEmail, buildRfiResponseEmail, } from "../src/services/rfiEmailFormat.js";
...
export function buildCommsFlowDemoMails() {
    ...
    const rfiCtx = {
        ...
        question: "Confirm membrane lap detail at UGWT–plinth junction per GFC AR-104. Contractor proposes alternate cold-joint — mock-up required?",
    ...
    const rfiResponse = buildRfiResponseEmail({
        ctx: rfiCtx,
        responseText: "Proceed with detail 3 on AR-104 Rev C. One junction mock-up before bulk pour — PMC to witness. (Portal auto-response for UAT — no human reply required.)",
    ...
    return [
        ...
        { subject: rfiRaised.subject, bodyHtml: rfiRaised.bodyHtml },
        {
            subject: `[${projectCode}] UAT 11/15 — RFI official response (automated)`,
            bodyHtml: rfiResponse.bodyHtml,
        },
        { subject: ncr.subject, bodyHtml: ncr.bodyHtml },
        { subject: car.subject, bodyHtml: car.bodyHtml },
        { subject: rfiClosed.subject, bodyHtml: rfiClosed.bodyHtml },
        {
...
//# sourceMappingURL=send-comms-flow-demo-pack.js.map