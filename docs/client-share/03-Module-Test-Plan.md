...
| 3 | **Documents (DMS)** | Browse ISO folders, upload, preview PDF | ☐ | ☐ | ☐ | ☐ |
| 4 | **Quality** | QI create, checklist fill, NCR/CAR, cube line | ☐ | ☐ | ☐ | ☐ |
| 5 | **Safety** | Safety observation, safety NCR (separate from QI) | ☐ | ☐ | — | ☐ |
| 6 | **Field / Site** | Day log, photos, field RFI, **attendance punch IST + SharePoint** | ☐ | ☐ | — | ☐ |
...
| 12 | **HRMS** | Employee record, attendance roster, leave request | ☐ | ☐ | — | ☐ |
