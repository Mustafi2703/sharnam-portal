...
|-------|----------------------------|
| Owner roles | Office / Site / Contractor / Client? |
| Link to drawings / QI / Safety | |
| Photo evidence rules | |
| Close-out sign-off | |
| Reports / export | |

**Proposed tools (draft):** Register · Assign · Photos · Close · Export  

---

## 2. Project closure (future)

| Topic | Decision |
|-------|----------|
| Checklist of closure docs | |
| Client pack contents | |
| Archive of drawings / RFIs / MoM | |
| Final NCR / snag zero gate | |

**Proposed tools (draft):** Closure checklist · Client pack · Archive · Sign-off  
...
| Invoice columns | |
| PO ↔ RA ↔ COP links | |
| Client / contractor visibility | |
| Import from Payment Summary sheet | |
